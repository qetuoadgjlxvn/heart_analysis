...
# print "#",tr_features,tr_labels
sm=SMOTE(random_state=12,ratio=0.7,k_neighbors=10,n_jobs=26)
tr_res,tr_labl=sm.fit_sample(tr_features,tr_labels)

print tr_res,tr_labels
tr_features,tr_labels=tr_res,tr_labl
uniqu,counts=np.unique(tr_labels,return_counts=True)
print dict(zip(uniqu,counts))
